export default {
  ...
  'preview-update': '업데이트 미리 보기',
  'checking-for-updates': '업데이트 확인 중...',
  'release-notes-not-found': '이번 업데이트에 대한 릴리스 노트를 찾을 수 없습니다. 애플리케이션 디렉터리의 릴리스 파일을 확인해 주세요',
  'update-available-message': '새 버전의 LinkCore를 사용할 수 있습니다. 지금 업데이트하시겠습니까?',
