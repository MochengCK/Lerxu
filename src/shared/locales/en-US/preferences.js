export default {
  ...
  'bt-xp-breakdown': 'XP Breakdown',
  'bt-xp-download': 'Download Contribution',
  'bt-xp-upload': 'Upload Contribution',
  'bt-xp-share-ratio': 'Share Ratio Bonus',
  'bt-xp-peers': 'Peer Connections',
  'bt-xp-seed-time': 'Seeding Time',
  'bt-xp-tasks': 'Completed Tasks',
  'bt-xp-unit': 'XP',
  'bt-peers-unit': 'peers',
  'bt-tasks-unit': 'tasks',
  'bt-share-ratio': 'Share Ratio',
  'bt-level-1': 'Network Newbie',
  'bt-level-1-subtitle': 'Just getting started with BT downloads',
  'bt-level-2': 'Establishing Connection',
  'bt-level-2-subtitle': 'Connected to the P2P network and building connections',
  'bt-level-3': 'Downloader',
  'bt-level-3-subtitle': 'Getting familiar with the BT downloading process',
  'bt-level-4': 'Active Node',
  'bt-level-4-subtitle': 'Maintaining high download activity',
  'bt-level-5': 'Contributor',
  'bt-level-5-subtitle': 'Sharing resources steadily with the network',
  'bt-level-6': 'Seeder',
  'bt-level-6-subtitle': 'Seeding long-term with solid sharing performance',
  'bt-level-7': 'Network Core',
  'bt-level-7-subtitle': 'Consistently playing an important role in the network',
  'bt-level-8': 'Veteran User',
  'bt-level-8-subtitle': 'Participating in distribution with long-term quality',
  'bt-level-9': 'BT Explorer',
  'bt-level-9-subtitle': 'An influential contributor to the BT network',
  'bt-max-level-reached': 'Congratulations! You have reached the maximum level',
  'bt-level-up-title': 'Level Up!',
  'bt-level-up-message': 'Congratulations! You have reached Lv.{{level}} {{name}}',
  'bt-level-up-notification-label': 'Level Up Notification',
  'bt-level-up-notification-tips': 'Show notification when your BT level increases',
  'bt-migration-success': 'BT statistics migrated successfully to engine',
  'bt-migration-pending': 'Level data migration will be retried on next startup',
  'bt-loading-level': 'Loading level data...',
  'bt-hint-days': 'Stay active for {days} more days to level up',
  'bt-hint-upload': 'Upload {size} more to level up',
  'bt-hint-download': 'Download {size} more to level up',
  'bt-statistics': 'BT Statistics',
  'bt-total-tasks': 'Total Tasks',
  'bt-completed-tasks': 'Completed Tasks',
  'bt-seeding-tasks': 'Seeding Tasks',
  'bt-total-downloaded': 'Total Downloaded',
  'bt-total-uploaded': 'Total Uploaded',
  'bt-total-seed-time': 'Total Seed Time',
  ...
  'background-ui-opacity-scope-floating-bar': 'Bottom bar',
  'background-ui-opacity-scope-task-plan': 'Task plan button',
  'background-ui-opacity-scope-speedometer': 'Speedometer',
  ...
  'background-ui-frosted-scope-floating-bar': 'Bottom bar',
  'background-ui-frosted-scope-task-plan': 'Task plan button',
  'background-ui-frosted-scope-speedometer': 'Speedometer',
  ...
  'task-progress-mode': 'Task progress mode',
  'task-progress-mode-component': 'Progress bar component',
  'task-progress-mode-background': 'Card background progress bar',
  ...
  'auto-hide-floating-bar': 'Hide bottom bar by default',
  ...
  'extension-exclude-domains': 'Do not hijack the following websites',
