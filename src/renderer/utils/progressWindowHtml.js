...
export function buildProgressWindowHtml (useCustomFrame, isMac, getThemeColors) {
 {
        ...
        const html = [
          ...
          '    barEl.style.backgroundColor = payload.pendingSelection ? "#f0ad4e" : (payload.isPaused ? "#8b95a3" : "#1a7fe0");',
          '  }',
          '  /* 待选择文件时进度为 0，内条没有宽度可言，底槽一并染色才看得出状态 */',
          '  var pendingTrackBg = payload.pendingSelection ? "rgba(240, 173, 78, 0.45)" : (currentTheme.barBg || "#e2e8f0");',
